...
function connect(opts) {
  var stream;
  var host = process.env.HOST || 'data.logentries.com';
  if (opts.secure) {
    stream = tls.connect(parseInt(process.env.PORT)||433, host, onSecure);
  } else {
    stream = net.createConnection(parseInt(process.env.PORT)||80, host);
  }
  function onSecure() {
